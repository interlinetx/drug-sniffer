...
process denovo_ligands {
    container '056117122700.dkr.ecr.us-west-2.amazonaws.com/03-denovo:latest'
...
process similarity_search {
    container '056117122700.dkr.ecr.us-west-2.amazonaws.com/04-similarity_search:latest'
...
process protein_ligand_docking {
    container '056117122700.dkr.ecr.us-west-2.amazonaws.com/05-protein_ligand_docking:latest'
...
process activity_prediction {
    container '056117122700.dkr.ecr.us-west-2.amazonaws.com/06-activity_prediction'
...
process admet_prediction {
    container '056117122700.dkr.ecr.us-west-2.amazonaws.com/07-admet_prediction'
...
process error_collation {
    container '056117122700.dkr.ecr.us-west-2.amazonaws.com/08-error_collation'
...
process results_collation {
    container '056117122700.dkr.ecr.us-west-2.amazonaws.com/09-results_collation'
